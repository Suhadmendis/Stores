...
function cal_subtot(count, totcount)
{
    ...
    ordQty_val = parseFloat(document.getElementById(ordQty).value);
    
    if (qty_val > ordQty_val){
        qty_val = ordQty_val;
    }	
...
//    alert(totcount);
    ...
    document.getElementById(qty).value = qty_val;
    document.getElementById("total_value").value = tot.toFixed(2) ;
}
...
//        params = params + "&purtype=" + document.getElementById('purtype').value;
        ...
        while (i < document.getElementById('count').value) {
            ...
            params = params + "&" + ord_qty_org + "=" + document.getElementById(ord_qty_org).value;
...
function result_pass_arnno()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("net_tot");
        opener.document.form1.net_value.value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("DISC");
        opener.document.form1.total_discount.value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("nbt_val");
        opener.document.form1.total_nbt.value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("vat_val");
        opener.document.form1.total_vat.value = XMLAddress1[0].childNodes[0].nodeValue;
