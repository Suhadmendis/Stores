...
function chk_chqno()
{
    ...
    if (document.getElementById('chqno').value!=""){	
        ...
        url=url+"?Command="+"dupChqNoDetails";
        url=url+"&chqno="+str;
        
        xmlHttp.onreadystatechange=chk_chqno_result;
        xmlHttp.open("GET",url,true);
        xmlHttp.send(null);
    }
}

function chk_chqno_result()
{
	var XMLAddress1;
 ...
 if (document.getElementById('cmd_utilization').value==1){
	...
	if (n1 != n2){
			...
			while (mcount > i){
				...
				if ( ((document.getElementById(chq_pay).value)!="")||((document.getElementById(cash_pay).value)!="")) {
					...
					params =params + '&'+dano+'='+document.getElementById(dano).innerHTML;
...
if (document.getElementById('invno').value!=""){	
 ...
 if (document.getElementById('cmd_utilization').value==1){
	...
	if (n1 != n2){
			...
			xmlHttp.onreadystatechange=utilization_save_result;
...
function utilization_save_result()
{
	var XMLAddress1;
