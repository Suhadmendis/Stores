...
{   
			...
			url=url+"&autoCode="+document.getElementById('autoCode').value;
...
function showarmyresult_addtmp()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		document.getElementById('qty').value="";
                ...
                var autoCode = parseInt(document.getElementById('autoCode').value);
                autoCode = autoCode + 1;
...
//			document.getElementById("nbt").checked = false;
			...
			document.getElementById('purType').value="ST";
...
function assignPurType()
{
			...
			var url="pur_ord_data_1.php";			
			url=url+"?Command="+"pass_assignPurType";
