...
function update_cust_list(stname,gridNo)
{   
			...
			} else if (stname=="pick_bank") {
				var url="search_ledger_data_acc.php";
				url=url+"?Command="+"search_custom_bank";
			} else {
				var url="search_ledger_data_acc.php";
				url=url+"?Command="+"search_custom";
			}
...
function ledgno(custno, stname, gridNo)
{   
			//alert(stname);
			...
			if ((stname=="cash_rec1")||(stname=="pick_bank")){
				var url="search_ledger_data_acc.php";			
				url=url+"?Command="+"pass_cash_rec";
				url=url+"&ledgno="+custno;
			...
			if (stname=="cash_rec2_grid"){
				var url="search_ledger_data_acc.php";			
				url=url+"?Command="+"pass_cash_rec_grid";
				url=url+"&ledgno="+custno;
				url=url+"&gridNo="+gridNo;
							
				//alert(url);
				xmlHttp.onreadystatechange=passcusresult_cash_rec2_grid;
			}
			...
			if (stname=="cash_rec3"){
				...
				//alert(url);
				xmlHttp.onreadystatechange=passcusresult_cash_rec3;
			}
...
function passcusresult_cash_rec2_grid()
{
	var XMLAddress1;
	...
	{
//		alert(xmlHttp.responseText);
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("gridNo");
                var accno = "accno"+XMLAddress1[0].childNodes[0].nodeValue;
                var acc_name = "acc_name"+XMLAddress1[0].childNodes[0].nodeValue;
                
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_code");	
		opener.document.getElementById(accno).value=XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_name");	
		opener.document.getElementById(acc_name).value=XMLAddress1[0].childNodes[0].nodeValue;
		
		self.close();
	}
}

function passcusresult_cash_rec3()
{
	var XMLAddress1;
...
//		alert(xmlHttp.responseText);
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_code");	
		opener.document.form1.accno3.value=XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_name");	
		opener.document.form1.acc_name3.value=XMLAddress1[0].childNodes[0].nodeValue;
