...
{   
		...
		//alert(inv_status);
			...
			url=url+"&invno="+document.getElementById('invno').value;
			url=url+"&reqno="+document.getElementById('reqno').value;
...
{   
			...
			objsalesrep.options[0].selected=true;
                        ...
                        document.getElementById('type').value="LO";
...
//		alert(xmlHttp.responseText)
	  ...
	  if (str.length>575){
		...
		opener.document.form1.type.value = XMLAddress1[0].childNodes[0].nodeValue;
                ...
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("purType");
...
{   
			...
			if (stname=='ord'){
				...
				xmlHttp.onreadystatechange=passarnsettyperesult;
				xmlHttp.open("GET",url,true);
				xmlHttp.send(null);
...
function passpurordresult()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("REQNO");
...
//		opener.document.form1.dte_shedule.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		opener.document.form1.brand.value = XMLAddress1[0].childNodes[0].nodeValue;
                ...
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("entBy");
                opener.document.form1.entBy.value = XMLAddress1[0].childNodes[0].nodeValue;
                
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("appBy");
                opener.document.form1.appBy.value = XMLAddress1[0].childNodes[0].nodeValue;
                ...
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("g_tot");
...
function passarnresult()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.department.value = XMLAddress1[0].childNodes[0].nodeValue;
                ...
                opener.document.form1.department.disabled = true;
...
//                opener.document.form1.type.value = XMLAddress1[0].childNodes[0].nodeValue;
                ...
                if(XMLAddress1[0].childNodes[0].nodeValue == "arn_1"){
