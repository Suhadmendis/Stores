...
function cal_subtot(count, totcount)
{
    ...
    var lineTotal = qty_val * cost_val;
    var nbtLine = 0;
    if(taxNum > 2){
        nbtLine = lineTotal*0.02;
    }
    var vatLine = 0;
    if ((taxNum == 1)||(taxNum == 3)){
        vatLine = (lineTotal + nbtLine)*0.15;
    }
    lineTotal = lineTotal + nbtLine + vatLine;
...
function save_inv(inv_status)
{
    ...
    if (document.getElementById('invno').value != "") {
        ...
        params = params + "&total_discount=" + document.getElementById('total_discount').value;
...
//        params = params + "&purtype=" + document.getElementById('purtype').value;
        ...
        while (i < document.getElementById('count').value) {
            ...
            if(document.getElementById('purType').value != "ST"){
                accno = "accno" + i;
                params = params + "&" + accno + "=" + document.getElementById(accno).value;
            }
            
            params = params + "&" + remarkname + "=" + document.getElementById(remarkname).value;
            params = params + "&" + invname + "=" + document.getElementById(invname).value;
            params = params + "&" + invdatename + "=" + document.getElementById(invdatename).value;
