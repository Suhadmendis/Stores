...
function result_pass_crnno()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.txtChqNo.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("ch_date");	
		opener.document.form1.txtChqDate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("ch_branch");	
		opener.document.form1.txtChqBranch.value = XMLAddress1[0].childNodes[0].nodeValue;
