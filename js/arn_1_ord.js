...
function cal_disc(count, totcount)
{
	
    var qty = 'qty' + count;
	var discount_a = 'discount_a' + count;
	var discount_b = 'discount_b' + count;
    var cost = 'cost' + count;
	...
	if (document.getElementById(discount_a).value == "") {
        discount_a_val = 0;
    } else {
        discount_a_val = parseFloat(document.getElementById(discount_a).value);
    }
	
	if (document.getElementById(discount_b).value == "") {
        discount_b_val = 0;
    } else {
        discount_b_val = parseFloat(document.getElementById(discount_b).value);
    }
	
	if (document.getElementById(selling).value == "") {
        selling_val = 0;
    } else {
        selling_val = parseFloat(document.getElementById(selling).value);
    }
	
	cost_val=selling_val*(1-discount_a_val*0.01);
	//alert("ok");
	cost_val=cost_val*(1-discount_b_val*0.01);
	
    document.getElementById(cost).value=cost_val;
...
function cal_subtot(count, totcount)
{
    ...
    var cost = 'cost' + count;
    var subtotal = 'subtotal' + count;
    var nbtHtml = 'nbt' + count;
    var vatHtml = 'vat' + count;
    
    var taxNum = 'taxNum' + count;
    taxNum = parseInt(document.getElementById(taxNum).value);
    
    var discount_a = 'discount_a' + count;
    var discount_a_agg = 0;
    ...
    var lineTotal = qty_val * cost_val - discount_a_val;
    var nbtLine = 0;
    if(taxNum > 2){
        var cal_nbt = parseFloat(document.getElementById("rate_nbt").value);
        nbtLine = lineTotal*cal_nbt/100;
    }
    var vatLine = 0;
    if ((taxNum == 1)||(taxNum == 3)){
        var cal_vat = parseFloat(document.getElementById("rate_vat").value);
        vatLine = (lineTotal + nbtLine)*cal_vat/100;
    }
    lineTotal = lineTotal + nbtLine + vatLine;
    
    document.getElementById(nbtHtml).value = nbtLine.toFixed(2) ;
    document.getElementById(vatHtml).value = vatLine.toFixed(2) ;
    document.getElementById(subtotal).value = lineTotal.toFixed(2) ;

    var i = 1;
    while (i < totcount) {
        var discount_aind = 'discount_a' + i;
        if (document.getElementById(discount_aind).value != '') {
            discount_a_agg = parseFloat(discount_a_agg) + parseFloat(document.getElementById(discount_aind).value);
        }
        var nbtind = 'nbt' + i;
        if (document.getElementById(nbtind).value != '') {
            nbt = parseFloat(nbt) + parseFloat(document.getElementById(nbtind).value);
        }
        var vatind = 'vat' + i;
        if (document.getElementById(vatind).value != '') {
            vat = parseFloat(vat) + parseFloat(document.getElementById(vatind).value);
        }
        var subtotalind = 'subtotal' + i;
        if (document.getElementById(subtotalind).value != '') {
            tot = parseFloat(tot) + parseFloat(document.getElementById(subtotalind).value);
    ...
    document.getElementById("total_discount").value = discount_a_agg.toFixed(2);
    
    var fixedNbt = nbt.toFixed(2);
    var fixedVat = vat.toFixed(2);
    var fixedTot = tot.toFixed(2);
    var net = fixedTot - fixedNbt -fixedVat;
    var fixedNet = net.toFixed(2);
    
    document.getElementById("net_value").value = fixedNet;
    document.getElementById("total_nbt").value = fixedNbt;
    document.getElementById("total_vat").value = fixedVat;
    document.getElementById("total_value").value = fixedTot;
}
...
function appr_inv()
{
			...
			var url="arn_data_1_ord.php";			
			url=url+"?Command="+"approve_item";
...
function save_inv(inv_status)
{
    ...
    if (document.getElementById('invno').value != "") {
		...
		var url='arn_data_1_ord.php';	
		var params = 'Command=save_item&invno='+document.getElementById('invno').value;
        ...
        params = params + "&supplier_name=" + myString;
        ...
        params = params + "&total_nbt=" + document.getElementById('total_nbt').value;
        params = params + "&total_vat=" + document.getElementById('total_vat').value;
        params = params + "&net_value=" + document.getElementById('net_value').value;
        ...
        isNbt = "false";
        if (document.getElementById('chk_nbt').checked==true){
                isNbt = "true";
        } 
        
        params = params + "&chk_nbt=" + isNbt;
        ...
        while (i < document.getElementById('count').value) {
			...
			params = params + "&" + discount_a + "=" + document.getElementById(discount_a).value;
			params = params + "&" + discount_b + "=" + document.getElementById(discount_b).value;
            params = params + "&" + cost + "=" + document.getElementById(cost).value;
            params = params + "&" + selling + "=" + document.getElementById(selling).value;
            params = params + "&" + taxNum + "=" + document.getElementById(taxNum).value;
...
function result_pass_arnno()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.form1.type.value = XMLAddress1[0].childNodes[0].nodeValue;
        
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("type1");
        opener.document.form1.purType.value = XMLAddress1[0].childNodes[0].nodeValue;
...
function new_inv()
{
    ...
    document.getElementById('entBy').value="";
    document.getElementById('appBy').value="";
    document.getElementById('net_value').value="";
    document.getElementById('total_nbt').value="";
...
//    document.getElementById('purtype').value="Local";
...
//        alert(xmlHttp.responseText);
        ...
        document.getElementById('rate_nbt').value = XMLAddress1[0].childNodes[0].nodeValue;
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("vatrate");	
        document.getElementById('rate_vat').value = XMLAddress1[0].childNodes[0].nodeValue;
    }
}
