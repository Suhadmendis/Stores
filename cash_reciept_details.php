...
<fieldset>
  ...
  <tr>
    ...
    <td colspan="3"><select name="salesrep" id="salesrep"  onkeypress="keyset('chqno',event);" class="text_purchase3">
      <?php
...
//    if (($_SESSION['UserName']=="ptsa") or ($_SESSION['UserName']=="ptsb") or ($_SESSION['UserName']=="ptsc")){
    if (true){
		echo "<input type=\"text\" size=\"20\" name=\"invdate\" id=\"invdate\"  value=\"". date("Y-m-d")."\" onfocus=\"load_calader('invdate')\"  class=\"text_purchase3\" />";
	
	} else {
		echo "<input type=\"text\" size=\"20\" name=\"invdate\" id=\"invdate\"  value=\"". date("Y-m-d")."\" onfocus=\"load_calader('invdate')\"  class=\"text_purchase3\" disabled=\"disabled\"/>";
	}	
  ...
  <tr>
    ...
    <td><font color="#FFFFFF"><font color="#FFFFFF"><a href="search_ledger_acc.php?stname=pick_bank" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
    ...
    <td><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" name="accno2" id="accno2" size="10" value="1013" onkeypress="keyset('chqdate',event);"      />
    </font></font></td>
    <td><font color="#FFFFFF"><font color="#FFFFFF">
    ...
    <table width="1200" border="0">
      ...
      <tr>
        ...
        <th scope="col" valign="top"><input type="button"  class="sell_search1" name="idcopy2" id="idcopy2" value="Display Image 1" onclick="NewWindow1('display_image.php?cou=image1','mywin','900','800','yes','center');return false" />
        ...
        <input type="button"  class="sell_search1" name="idcopy3" id="idcopy3" value="Display Image 3" onclick="NewWindow1('display_image.php?cou=image3','mywin','900','800','yes','center');return false" /></th>
      </tr>
    </table>
