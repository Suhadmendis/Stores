    ...
    <form name="form1" id="form1">            
        <table width="100%" border="0"  class=\"form-matrix-table\">
            <tr>
                ...
                <td width="10%"><a href="search_purord_1.php?stname=ord" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');return false" onfocus="this.blur()">
            ...
            <tr>
                ...
                <td><select name="purType" id="purType" onkeypress="keyset('searchitem', event);" class="text_purchase3"  onchange="assignPurType();">
            ...
            <table width="84%" border="0">
                <tr>
                    ...
                    <td  width="10%"><span class="style1">
                        ...
                        <td  width="10%"><span class="style1">
                            <input type="hidden"  class="label_purchase" value="Cost" disabled/>
                        </span></td>
                </tr>
                <tr>
                    <td><font color="#FFFFFF">
                        <div id="test"><font color="#FFFFFF">
                            <input type="text"  class="text_purchase3" name="itemd_hidden" id="itemd_hidden" size="10" disabled="disabled" onkeypress="keyset('qty', event);"  onblur="itno_ind();"    />
                            </font></div>  </font></td>
                    <td><font color="#FFFFFF">
                        <input type="text"  class="text_purchase6" size="40" id="itemd" name="itemd" onkeypress="keyset('rate', event);" />
                        </font><a href="serach_item_purord_rawmas.php" onClick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');return false" onFocus="this.blur()"><input type="button" name="searchitem" id="searchitem" value="..." class="btn_purchase" ></a></td>
                    <td><font color="#FFFFFF">
                    ...
                    <td><font color="#FFFFFF">
                        <input type="hidden" size="15" name="cost" id="cost" value="0" class="text_purchase3"  onKeyPress="keyset('additem_tmp', event);"/>
                        </font></td>
                    <td><input type="button" name="additem_tmp" id="additem_tmp" value="Add" onClick="add_tmp();" class="btn_purchase1"><input type="hidden" size="15" name="autoCode" id="autoCode" value="1"/></td>
                </tr>
                <tr>
                    <td colspan="4">
