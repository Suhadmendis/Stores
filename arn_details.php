...
<form name="form1" id="form1">            
  ...
  <tr>
    <td width="14%"><input type="text"  class="label_purchase" value="STR ARN No" disabled/></td>
  ...
  <tr>
    ...
    <td><select name="purType" id="purType" onkeypress="keyset('searchitem', event);" class="text_purchase3" disabled="disabled">
...
<table>
    ...
    <td width="10%"><font color="#FFFFFF">
      <input type="text" size="20" name="total_value" id="total_value" value="" onblur="calc1();" class="text_purchase3" onkeypress="keyset('discount',event);" disabled="disabled"/>
    </font></td>
    </tr>
</table>
