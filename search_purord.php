    ...
    <body>
        ...
        <div class="CSSTableGenerator" >
            <div id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
                    ...
                    if (($stname!="arn")&&($stname!="arn_1")&&($stname!="arn_1_ord")){
                        $sql = "SELECT * FROM s_ordmas order by SDATE DESC limit 50";
                    }else if(($stname=="arn_1")){
                        $sql = "SELECT * FROM s_purmas_tmp where CANCEL='0' order by SDATE DESC limit 50";
                    }else if(($stname=="arn_1_ord")){
                        //$sql = "SELECT * FROM s_purmas_tmp where CANCEL='0' order by SDATE DESC limit 50";
                        //new pick up
                        $sql = "SELECT * FROM s_ordmas_1 where cancel='0' order by SDATE DESC limit 50";        
                    } else {
