...
if ($_GET["Command"]=="pass_cus_cash_rec")
{
	...
	echo "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n";
			...
			if ($_GET['refno']==""){
				...
				$sql = mysql_query("Select C_CODE, REF_NO, deli_date,dele_no, GRAND_TOT, TOTPAY, SDATE from s_salma where C_CODE='".$_GET['custno']."' and GRAND_TOT > TOTPAY and (GRAND_TOT-TOTPAY)>0 and CANCELL='0' and company = '".$_SESSION["company"]."' ORDER BY SDATE") or die(mysql_error());
			} else {
