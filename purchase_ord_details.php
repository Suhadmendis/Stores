    ...
    <form name="form1" id="form1">            
        <table width="100%" border="0"  class=\"form-matrix-table\">
            ...
            <tr>
                ...
                <td><input type="text" name="reqno" id="reqno" value="" class="text_purchase3" disabled="disabled"  /></td>
                <td><a href="search_purord_1.php?stname=req" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');return false" onfocus="this.blur()">
                    <input type="button" name="searchinv" id="searchinv" value="..." class="btn_purchase1" />
                </a></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><select name="type" id="type" onkeypress="keyset('searchitem', event);" class="text_purchase3">
        ...
        <fieldset>               
            ...
            <table width="84%" border="0">
                ...
                <tr>
                    ...
                    <td><font color="#FFFFFF">
                        <input type="text" size="15" name="cost" id="cost" value="" class="text_purchase3"  onKeyPress="keyset('additem_tmp', event);"/>
                        </font></td>
