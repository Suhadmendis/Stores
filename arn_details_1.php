...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Stores ARN Details</div>
                                               	 </legend>             
...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="15%"><input type="text" name="invno" id="invno" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);"  />
      <a href="serach_arn.php?stname=arn_1" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
  ...
  <tr>
    ...
    <td><input type="text"  class="label_purchase" value="Stores ARN No" disabled="disabled"/></td>
    <td width="14%"><input type="text" name="orderno1" id="orderno1" value="" onkeypress="keyset('orderdate',event);" class="text_purchase3"/>
     <a href="search_purord.php?stname=arn_1" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()"><input type="button" name="searchord" id="searchord" value="..." class="btn_purchase1" ></a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>
      <select name="type" id="type" class="text_purchase3" disabled="disabled">
