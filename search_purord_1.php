...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="JavaScript" src="js/pur_ord_1.js"></script>
        <style type="text/css">
    ...
    <body>
        ...
        <div class="CSSTableGenerator" >
            <div id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
					...
					if (($stname!="arn")&&($stname!="req")){
                    	$sql = "SELECT * FROM s_ordmas_1 order by SDATE DESC";
					} else {
						$sql = "SELECT * FROM s_ordmas_1 where cancel='0' order by SDATE DESC";
					}	
                    echo $sql;                    
