...
$sql = "Select * from s_mrnmas where tmp_no='" . $_GET['tmp_no'] . "'";
...
$html .="<body> 
        ...
        <table   style='width: 660px;' class='table1'>
            ...
            <tr>
             ...
             <tr>
                <th colspan='3' class='bottom head'><center>Material Request Note</th>
             </tr>
...
$i = 1;
//$mnet = 0;
$sql = "Select * from s_mrntrn where REFNO='" . $row["REF_NO"] . "' and LEDINDI = 'GINR'";
...
$html .="</table>
        ...
        <table style='width: 660px;' class='table1'>
            ...
            <tr>
                ...
                <td align='right'>Date of Request</td>
