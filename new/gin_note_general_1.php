...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Direct Sale Request</h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" placeholder="MIN No" id="txt_jobno" class="form-control  input-sm" disabled="">
                    </div>
                    <div class="col-sm-1" id="searchCustDiv" style="visibility: hidden;">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" onclick="NewWindow('serach_item.php?stname=dsr_itm', 'mywin', '800', '700', 'yes', 'center');
...
<script src="js/gin_general_1.js"></script>
<script>
                            new_inv();
</script>
<?php
