...
function save_inv(status) {
    ...
    url = url + "&txt_caddress=" + document.getElementById('txt_caddress').value;
...
function pass_rec_result()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if ((stname == "") || (stname == "mrn") || (stname == "ming") || (stname == "isa") || (stname == "ginu") || (stname == "mrni") || (stname == "mrng")) {
            ...
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("trf_qty");
            opener.document.form1.txt_trfd.value = XMLAddress1[0].childNodes[0].nodeValue;
            
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("bal_qty");
            ...
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("costing_no");
            opener.document.form1.txt_jobno.value = XMLAddress1[0].childNodes[0].nodeValue;
