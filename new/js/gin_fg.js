...
function new_inv() {
    ...
    document.getElementById('txt_jobQty').value = "";
    document.getElementById('txt_trfd').value = "";
    document.getElementById('txt_balTrfd').value = "";
