...
function update_list_dsr(stname) {
    ...
    var url = "invoice_data.php";
    url = url + "?Command=" + "update_list_dsr";
...
function pass_rec_result()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if ((stname == "")||(stname == "dinv")||(stname == "inv_dbn")) {
...
function dsrview(custno, stname)
{
    try {
        ...
        var url = "invoice_data.php";
        url = url + "?Command=" + "pass_dsr";
        url = url + "&refno=" + custno;
        url = url + "&stname=" + stname;

        xmlHttp.onreadystatechange = pass_dsr_result;
