...
//        if ((qty > 0) && (qty < stkLvl)) {
        ...
        var url = "gin_data_general_1.php";
...
function new_inv() {
    ...
    document.getElementById('svat').disabled = false;
    document.getElementById('searchCustDiv').style.visibility = "hidden";
...
function setType() {
    ...
    document.getElementById('svat').disabled = true;
    document.getElementById('searchCustDiv').style.visibility = "visible";
}