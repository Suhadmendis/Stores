        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('serach_gin.php?stname=mrnx', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('serach_job.php?stname=pickJOB', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
...
<script src="js/gin_mrn_ex.js"></script>
<script>
                            new_inv();
</script>
<?php
